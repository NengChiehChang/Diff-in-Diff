...
for (i in 1:B){
  ...
  nn = neuralnet(treatment~X1+X2+X3+X4+X5, data1, hidden = 2, threshold = 0.01, linear.output = TRUE)
...
par(mfrow=c(1,2))
hist(thetahat[which(abs(thetahat-6)<1)],breaks=100,main="Abadie",xlab="",ylab="")
